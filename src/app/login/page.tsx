    ...
    <div className="min-h-screen flex flex-col items-center justify-start bg-black text-white px-4 py-12 overflow-y-auto">
      ...
      <div className="w-full max-w-md bg-[#111] border border-[#2A2A2A] rounded-2xl p-8 text-center mb-6">
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-white hover:bg-gray-100 text-black font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-3 mb-4"
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-[#666] text-xs uppercase tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>or</span>
          <div className="flex-1 h-px bg-[#2A2A2A]"></div>
        </div>
